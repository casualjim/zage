...
## Classical command prediction papers (newly curated)

- **Davison & Hirsh (1997)** — C4.5 decision tree baseline, ~38.5% accuracy. First systematic UNIX command prediction study.
  - `https://www.cse.lehigh.edu/~brian/pubs/1997/mltr41/mltr41.pdf`
  - HCI companion: `https://www.cse.lehigh.edu/~brian/pubs/1997/hci/`

- **Schonlau et al. (2001)** — SEA dataset, six detection methods (Bayes One-Step Markov, Uniqueness, Compression, IPAM, Sequence-Match).
  - `https://projecteuclid.org/journals/statistical-science/volume-16/issue-1/Computer-Intrusion-Detecting-Masquerades/10.1214/ss/998929476.pdf`

- **Maxion & Townsend (2002–2003)** — Enriched vs. truncated command lines; 56% improvement with full command data.
  - Truncated: `https://www.cs.cmu.edu/~maxion/pubs/MaxionTownsend02.pdf`
  - Enriched: `https://www.cs.cmu.edu/~maxion/pubs/MaxionDSN03.pdf`

- **Durant & Smith (2002)** — Decision tables/trees, 40-42% accuracy, confirms diminishing returns.
  - `https://www.witpress.com/Secure/elibrary/papers/DATA02/DATA02042FU.pdf`

- **Kim & Cha (2005)** — SVM masquerade detection; data characteristics are the bottleneck, not model sophistication.

- **Tapiador et al. (2012)** — Online Action Randomization; behavioral privacy concerns for command prediction.
  - `https://link.springer.com/article/10.1007/s10922-012-9246-0`

## Neural/embedding approaches (newly curated)

- **Singh et al. (2021)** — LSTM vs. BERT vs. KB-augmented embeddings; "semantic deficit" concept.
  - `https://link.springer.com/article/10.1007/s11042-020-10109-y`

- **CL4SRec (SIGIR 2021)** — Contrastive sequential recommendation; item cropping/masking/reordering augmentations.
  - `https://arxiv.org/abs/2010.14395`

- **Verbeek & Hassani (CoopIS 2024)** — Online continual learning for next-activity prediction; per-context replay buffers.
  - `https://research.tue.nl/en/publications/handling-catastrophic-forgetting-online-continual-learning-for-ne`

- **Gros / AInix (2019)** — Ambiguity-aware NL→Shell with interactive clarification.
  - `https://www.cs.utexas.edu/~ml/papers/gros.thesis19.pdf`

- **Bash History Novelty Detection (2020)** — Autoencoder + word2vec on command tokens for user identification.
  - `https://par.nsf.gov/servlets/purl/10213652`
